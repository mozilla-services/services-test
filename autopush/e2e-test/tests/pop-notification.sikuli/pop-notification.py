...
NIGHTLY64 = "C:/Program Files/%s/firefox.exe -height 768 -width 1024"\
            % APP_NAME
...
URL_ENTRY_POINT_1 = Pattern(
    PATH_IMGS + "url_entry_moz.png").targetOffset(110, -4)
URL_ENTRY_POINT_2 = PATH_IMGS + "url_entry_search.png"
URL_ENTRY_POINT_3 = Pattern(
    PATH_IMGS + "url_entry_nightly.png").targetOffset(59, 0)
URL_ENTRY_POINT_4 = Pattern(
    PATH_IMGS + "url_entry_green_padlock.png").targetOffset(59, 1)
